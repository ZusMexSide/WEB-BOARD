...
<html lang="en">
    ...
    <body>
        ...
        <div class="section-title-wr  style-2 base base-al">
            <br>
            <h4 class="section-title left"> <span> <?php echo $proyecto['nombre'] ?> </span> Inicio: <?php echo date('d-m-Y', strtotime($proyecto['fecha'])) ?> Expiracion:  <?php echo date('d-m-Y', strtotime($proyecto['fecha_exp'])) ?>  </h4>
        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalEditarProyecto"onclick="SetContents();">Editar descripcion del proyecto</a>
                ...
                <div class="modal-content">
                    <form method="post" >
                        <div class="modal-header">
                            <h5 class="modal-title text-dark" id="exampleModalLabel">Ingrese los datos para modificar la descripcion del proyecto</h5>
