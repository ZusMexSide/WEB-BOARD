...
<html lang="en">
  <head>
   ...
   <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
      <link rel="stylesheet" href="css/AgregarPersonas.css"> 
 <title>Usuarios</title>
  ...
  <div class="collapse navbar-collapse p-2" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      <a class="nav-item nav-link" href="proyectos.html">Proyectos</a>
        <a class="nav-item nav-link active" href="generarProyecto.html">Generar Proyecto<span class="sr-only">(current)</span></a>
  ...
  <div class="row">
    <div class="col-sm">
      <div class="texto"> <h3> Selecione usuarios para el proyecto </h3> </div>
    </div>
  ...
  <div class="row justify-content-center">
    <div class="col-12">
   <div class="reg"> <a class="regresar" href="generarProyecto.html">Agregar</a> </div>
    </div>
  </div>
</div>
